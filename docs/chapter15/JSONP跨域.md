...
　　包裹后的响应会成为`<script>`元素的内容，它先判断JSON编码后的数据，然后把它传递给`handleResponse()`函数
...
https://user-gold-cdn.xitu.io/2019/3/5/1694e8c78233a533?imageView2/0/w/1280/h/960/format/webp/ignore-error/1